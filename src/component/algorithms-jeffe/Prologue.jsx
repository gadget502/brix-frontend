      ...
      <P.BulletList>
        ...
        <P.BulletListItem title='Proof techniques'>
          <P.Run>
            ...
            and whenever Chapter <P.InlMat>n-1</P.InlMat> uses induction, so does
            Chapter <P.InlMat>n</P.InlMat>.</P.Run>
        </P.BulletListItem>
        ...
        <P.BulletListItem title='Mathematical maturity'>
          <P.Run>
            Asymptotic notation <P.InlMat>(o, O, \Theta, \Omega, \omega)</P.InlMat>,
